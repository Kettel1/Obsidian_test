...
6. Темная тема в админ панели(для удобной работы вечером)
7. Отзывы для клиентов после рейса с возможностью ответа на них
8. Реализовать [[BRAINSTORM|дополнительные]] рейсы
