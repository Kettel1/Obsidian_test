...
30. [x] 650 рублей записывается в рейс устье -урай
31. [ ] Остановка Аэропорт, добавить возможность скрыть остановки
32. [ ] Массовое оповещение пассажиров

Мы не можем гаранитровать 100% отправку сообщений
1) может не дойти из-за оператора
2) может не хватить денег, стоимость будет от 300 до 500 рублей рассылка стоить
Нужно доказать симку для исходящих звонков